...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		$message = $core->show_message('error','Not all fields have been filled in correctly. The host, username, database name, company name, company email, currency, admin email, admin username and password are required.');
	}
}
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php if(is_writable($db_config_path)){?>
		  ...
		  <label for="site_name">Site Name</label><input type="text" id="site_name" value="<?php echo (isset($_POST['site_name'])) ? $_POST['site_name'] : ''; ?>" class="input_text" name="site_name" />
		  <label for="company_email">Site email</label><input type="text" id="company_email"  value="<?php echo (isset($_POST['company_email'])) ? $_POST['company_email'] : ''; ?>" class="input_text" name="company_email" />
		  <label for="currency_symbol">Currency Symbol</label><input type="text" id="currency_symbol" value="<?php echo (isset($_POST['currency_symbol'])) ? $_POST['currency_symbol'] : ''; ?>" class="input_text" name="currency_symbol" />
		  ...
		  <label for="admin_username">Username</label><input type="text" id="admin_username"  value="<?php echo (isset($_POST['admin_username'])) ? $_POST['admin_username'] : ''; ?>" class="input_text" name="admin_username" />
          <label for="admin_password">Password</label><input type="password" id="admin_password" class="input_text" name="admin_password" />
